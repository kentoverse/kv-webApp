...
export default function HeaderKV ({ children }){
    ...
    return (
        <>
            <header className={`${theme} flex min-h-screen flex-col items-center justify-between p-24`}>
                <div className="header-wrapper z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
                <LogoText></LogoText>
